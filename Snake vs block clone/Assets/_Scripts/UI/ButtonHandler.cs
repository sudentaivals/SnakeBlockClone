...
public class ButtonHandler : MonoBehaviour
{
    ...
    public void PlayHighlightSound()
    {
        ...
        EventBus.Publish(EventBusEvent.PlaySound, this, new PlaySoundEventArgs(_highlightVolume, _highlightClip));
    }
    public void PlayClickSound()
    {
        EventBus.Publish(EventBusEvent.PlaySound, this, new PlaySoundEventArgs(_clickVolume, _clickClip));
    }
