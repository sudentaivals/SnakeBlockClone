...
public class SoundManager : SingletonInstance<SoundManager>
{
    ...
    {
        EventBus.Subscribe(EventBusEvent.PlaySound, PlaySound);
    }


    private void OnDisable()
    {
        EventBus.Unsubscribe(EventBusEvent.PlaySound, PlaySound);
    }
    ...
    private void PlaySound(UnityEngine.Object sender, EventArgs args)
    {
        ...
        if (availableSource == null)
        {
            ...
            newSource.pitch = soundArgs.Pitch;
            newSource.Play();
        }
        else
        {
            ...
            availableSource.pitch = soundArgs.Pitch;
